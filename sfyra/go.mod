...
replace (
	...
	k8s.io/kube-openapi => k8s.io/kube-openapi 5b3e3fdb0acf
	k8s.io/utils => k8s.io/utils b8788abfbbc2
...
require (
	github.com/siderolabs/cluster-api-control-plane-provider-talos v0.5.12
	...
	github.com/siderolabs/talos v1.12.5
...
require (
	...
	github.com/siderolabs/cluster-api-bootstrap-provider-talos v0.6.11 // indirect
